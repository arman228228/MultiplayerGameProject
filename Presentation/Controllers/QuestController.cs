...
public class QuestController : ControllerBase
{
    ...
    public async Task<IActionResult> Create(CreateQuestDto dto)
    {
        ...
        if (quest == null) return Conflict("Error key");
    ...
    public async Task<IActionResult> GetById(int id)
    {
        ...
        if (quest == null) return NotFound($"Quest with ID: {id} not found");
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        if (!quests.Any()) return NotFound($"Quests not found");
    ...
    public async Task<IActionResult> Update(int id, UpdateQuestDto request)
    {
        ...
        if (!updatingResult) return NotFound($"Quest not found");
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        if (!deletionResult) return NotFound($"Quest not found");
